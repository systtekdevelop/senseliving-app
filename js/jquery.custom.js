...
(function () {
	...
	$( "#panel-right" ).load( "<?php get_theme_file_uri('/panel-right.php'); ?>" );
	$( "#panel-bottom" ).load( "<?php get_theme_file_uri('/panel-bottom.php'); ?>", function() {
	...
	$( "#popup-login" ).load( "<?php get_theme_file_uri('/popup-login.php'); ?>" );
	$( "#popup-signup" ).load( "<?php get_theme_file_uri('/popup-signup.php'); ?>" );
	$( "#popup-forgot" ).load( "<?php get_theme_file_uri('/popup-forgot-password.php'); ?>" );
	$( "#popup-social" ).load( "<?php get_theme_file_uri('/popup-social-share.php'); ?>" );
	
	$( "#header-page" ).load( "<?php get_theme_file_uri('/header-page.php'); ?>" );
